...
X_train, X_test, y_train, y_test = train_test_split(X_text, y_labels, test_size=0.2, stratify=y_labels, random_state=42)
...
for k, v in clasificadores.items():
    ...
    modelo = {}
    modelo['nombre'] = k
    modelo['accuracy'] = accuracy_score(y_true_test, y_pred=predicciones)
    modelo['precision'] = precision_score(y_true_test, y_pred=predicciones, average='weighted')
    modelo['recall'] = recall_score(y_true_test, y_pred=predicciones, average='weighted')
    modelo['f1'] = f1_score(y_true_test, y_pred=predicciones, average='weighted')
